...
<head>
    ...
    <title>WeThrift - Edit Profile</title>
            ...
            <?= csrf_field() ?>
                <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="tel" id="telephone" name="no_hp" placeholder="Enter your telephone number">
                    </div>
                    <div class="input-group">
                        <label for="account">Account:</label>
                        <input type="email" id="account" name="email" placeholder="Enter your email address">
                    </div>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="address" name="alamat" placeholder="Enter your address">
                    </div>

                    <button type="submit" class="save-button" onclick="location.href='profile'">Save</button>
            <?= form_close() ?>
        </div>
    </div>
