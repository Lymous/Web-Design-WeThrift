...
<html lang="id">
    <head> 
        ...
        <style>
            *{
            ...
            .products-container { /* Container baru untuk produk */
                display: flex;
            ...
            .product {
                ...
                padding: 15px;
                width: 200px; /* Sesuaikan lebar produk sesuai kebutuhan */
                height: 270px;
            }
    ...
    <body>
        ...
        <?php foreach ($daftar_market as $market) {
        ?>
        
                        <div class="product">
                            <img src="<?= base_url('fotohome/') ?><?= $market['gambar'] ?>" alt="Produk 1"> 
                            <h5><?= $market['produk'] ?></h5>
                            <p>Rp. <?= $market['harga'] ?></p>
                            <button><a href="cartada/add/<?= $market['id'] ?>">BUY NOW</a></button>
                        </div>
         <?php }  ?>
